...
export default function Equipment() {
  ...
  const [selectedEquipmentForCarbon, setSelectedEquipmentForCarbon] = useState(null);
  ...
  const handleCarbonCalculation = (equipment: any) => {
    setSelectedEquipmentForCarbon(equipment);
    setShowCarbonCalculator(true);
  };

  // Close carbon calculator
  const handleCloseCarbonCalculator = () => {
    setShowCarbonCalculator(false);
    setSelectedEquipmentForCarbon(null);
  };
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Button 
              variant="outline" 
              className="bg-white/10 border-white/20 text-white hover:bg-white/20 backdrop-blur-sm"
              onClick={() => setShowCarbonCalculator(true)}
            >
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CarbonFootprintCalculator 
              equipment={selectedEquipmentForCarbon}
              onClose={handleCloseCarbonCalculator}
            />
          </div>
        </div>
      )}

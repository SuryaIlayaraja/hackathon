...
const defaultExpenses: Expense[] = [
  ...
  const addExpense = (newExpense: FormData) => {
    ...
    setToastMessage(`₹${newExpense.amount} expense recorded successfully`);
    setShowToast(true);
  ...
  const confirmDelete = () => {
    if (expenseToDelete) {
      ...
      setToastMessage('Expense removed successfully');
      setShowToast(true);
      setTimeout(() => setShowToast(false), 3000);
    }
      ...
      <div className="flex justify-between items-center relative z-10">
        <div>
          ...
          <p className="text-white text-xl opacity-90 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
            Monitor and optimize your farming costs for better profitability.
          </p>
          <div className="mt-4 flex items-center space-x-4">
            <div className="flex items-center bg-white bg-opacity-20 px-4 py-2 rounded-full">
              <span className="text-white text-sm font-medium">💰 Smart Savings</span>
            </div>
            <div className="flex items-center bg-white bg-opacity-20 px-4 py-2 rounded-full">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-50 to-transparent opacity-50"></div>
        ...
        <div className="flex justify-between items-start">
          <div>
              ...
              <p className="text-sm text-gray-500">Based on recent data</p>
            <div className="mt-3 w-full bg-gray-200 rounded-full h-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">🚛 Diesel Cost Optimization</h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">Consider group fuel purchases to reduce costs by 8-12%</p>
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">🌱 Fertilizer Bulk Buying</h3>
              </div>
              <p className="text-gray-700 mb-4 text-lg">Join collective orders for 15% savings on fertilizers</p>
...
const AddExpenseModal: React.FC<{
  ...
  const categories = [
    'Seeds', 'Fertilizer', 'Diesel', 'Tools', 'Labor', 'Pesticides', 'Irrigation', 'Machinery', 'Other'
  ];

  const types = ['Essential', 'Operational', 'Equipment', 'Labor'];
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-farm-yellow rounded-t-2xl px-8 py-6 mb-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-white text-lg">Track your farming expenses by month</p>
              </div>
              <button
                onClick={onBack}
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Select Month</h2>
            <input
              type="month"
              value={selectedMonth}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">Total for {formatMonthYear(selectedMonth)}</h3>
              <p className="text-3xl font-bold text-gray-900">₹{monthlyTotal.toLocaleString()}</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">Number of Expenses</h3>
              <p className="text-3xl font-bold text-gray-900">{monthlyExpenses.length}</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">Average per Expense</h3>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          ...
          {monthlyExpenses.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">No expenses recorded for {formatMonthYear(selectedMonth)}</p>
            </div>
          )}
        </div>
      </div>
    ...
    <div className="fixed bottom-6 right-6 bg-white rounded-xl shadow-glow border border-gray-200 p-6 z-50 animate-slide-up hover-lift">
      <div className="flex items-center">
        ...
        <div className="flex-1">
          <p className="font-bold text-gray-900 text-lg animate-bounce-in">🎉 Expense Added!</p>
